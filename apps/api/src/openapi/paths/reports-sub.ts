...
export const reportSubPaths = {
  '/reports/{id}/evidence': {
    get: {
      ...
      parameters: idParam,
      responses: { '200': { description: 'OK', content: { 'application/json': { schema: { type: 'object', properties: { data: { type: 'array', items: evidence } } } } } }, '404': errResp },
    },
    post: {
      ...
      responses: { '201': { description: 'Created' }, '401': errResp, '403': errResp, '404': errResp },
    },
  },
  ...
  '/reports/{id}/comments': {
    get: {
      ...
      parameters: idParam,
      responses: { '200': { description: 'OK', content: { 'application/json': { schema: { type: 'object', properties: { data: { type: 'array', items: comment } } } } } }, '404': errResp },
    },
    post: {
      summary: 'Post a comment',
      security: bearer,
      parameters: idParam,
      requestBody: { required: true, content: { 'application/json': { schema: { type: 'object', required: ['body'], properties: { body: { type: 'string', minLength: 1, maxLength: 1000 }, parentId: { type: 'string', format: 'uuid', nullable: true } } } } } },
      responses: { '201': { description: 'Created' }, '401': errResp, '404': errResp, '422': errResp },
    },
  },
